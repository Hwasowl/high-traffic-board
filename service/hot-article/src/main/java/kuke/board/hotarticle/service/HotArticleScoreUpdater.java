...
public class HotArticleScoreUpdater {
    ...
    private static final Duration HT_ARTICLE_TTL = Duration.ofDays(10);
    ...
    public void update(Event<EventPayload> event, EventHandler<EventPayload> eventHandler) {
        ...
        hotArticleListRepository.add(articleId, createdTime, score, HOT_ARTICLE_COUNT, HT_ARTICLE_TTL);
    }
