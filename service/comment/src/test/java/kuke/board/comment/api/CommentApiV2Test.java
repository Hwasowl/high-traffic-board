...
public class CommentApiV2Test {
    ...
    void create() {
        ...
        //response1.getCommentId() = 177328566797058048
        //	response2.getPath() = 0000000000
        //	response2.getCommentId() = 177328567455563776
        //		response3.getPath() = 000000000000000
        //		response3.getCommentId() = 177328567518478336
    }
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v2/comments/{commentId}", 177328567455563776L)
                .retrieve()
                .body(CommentResponse.class);
